...
local_url = 'http://192.168.187.150:8686/input'
headers = {'Content-Type': 'application/json'}

# Чтение CSV файла и отправка данных в SIEM
with open('/usr/src/logs/super_mega_critical.csv', newline='') as csvfile:
    ...
    for row in reader:
        ...
        response = requests.post(local_url, data=json_data, headers=headers)
